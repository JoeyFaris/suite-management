...
.then((data) => setRequests(data))
  ...
  <div class="block rounded-lg shadow-lg bg-white max-w-sm text-center">
    <div class="p-6">
      <h5 class="text-gray-900 text-xl font-medium mb-2">{request.category}</h5>
  ...
  return (
    <div class="absolute justify-center ml-72 pl-20 py-20 w-10/12 pr-20 bg-gray-100">
...
<div class="grid grid-cols-3 gap-5 py-20 items-start">{renderRequests}</div>
</div>
